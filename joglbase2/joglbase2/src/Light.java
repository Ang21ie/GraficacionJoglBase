...
class Light extends GLJPanel implements GLEventListener, KeyListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glShadeModel(GL_FLAT); //Este es mas vectorizado que el GL_SMOOTH
        //gl.glShadeModel(GL_SMOOTH); // blends colors nicely, and smoothes out lighting  

        //Todo esto son códigos para la implementación de sombras
        ...
        //Este es el que activa el foco de luz que se mueve
        ...
        /*CAda luz tiene 3 característicaS:
        Parte difuza
        Parte ambiental
        Parte Color*/
    ...
    public void drawFigure(GL2 gl, GLUT glut) {
        ...
        this.setSomeGreenMaterial(gl, GL.GL_FRONT); //Se dibuja un objetode color verde
        glut.glutSolidTeapot(1.0f, true);

        this.setSomeRedMaterial(gl, GL.GL_FRONT); //De color rojo y queda
        //gl.glTranslatef(2.0f, 1.0f, -1.0f);
        glut.glutSolidTorus(0.5, 1, 20, 20); //Este es un ejemplo de una donita
    ...
    public void display(GLAutoDrawable glad) {
        ...
        this.drawFigure(gl, glut); //Aqui otra funcion manda a dibujar las figuras
