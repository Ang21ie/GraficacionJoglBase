...
public class TJOGL2 extends GLJPanel implements GLEventListener, KeyListener {
    ...
    Texture cargarTextura(String imageFile) {
        Texture text1 = null;
        System.out.println("Entra al cargar textura");
        try {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        // Se dibuja la piramide Tarea que pidió
        //this.drawPyramid(2, 0, 0, 1, 1, gl);
        this.drawCube(gl);
     ...
     * in texture image. ___________ | | T | | |___|___|___| | L | F | R |
     * |___|___|___| | | B | BB| |___|___|___|
     */
    public static void drawCubeUVWmapped(GL2 gl) {
        gl.glBegin(GL2.GL_QUADS);
        // Left Face
        gl.glTexCoord2f(0.0f, .33f);
        gl.glVertex3f(-1.0f, -1.0f, -1.0f);	// Bottom Left
        gl.glTexCoord2f(.33f, .33f);
        gl.glVertex3f(-1.0f, -1.0f, 1.0f);	// Bottom Right
        gl.glTexCoord2f(.33f, .66f);
        gl.glVertex3f(-1.0f, 1.0f, 1.0f);	// Top Right
        gl.glTexCoord2f(0.0f, .66f);
        gl.glVertex3f(-1.0f, 1.0f, -1.0f);	// Top Left
        // Front Face
        gl.glTexCoord2f(.33f, .33f);
        gl.glVertex3f(-1.0f, -1.0f, 1.0f);	// Bottom Left
        gl.glTexCoord2f(.66f, .33f);
        gl.glVertex3f(1.0f, -1.0f, 1.0f);	// Bottom Right
        gl.glTexCoord2f(.66f, .66f);
        gl.glVertex3f(1.0f, 1.0f, 1.0f);	// Top Right
        gl.glTexCoord2f(.33f, .66f);
        gl.glVertex3f(-1.0f, 1.0f, 1.0f);	// Top Left
        // Right face
        gl.glTexCoord2f(.66f, .33f);
        gl.glVertex3f(1.0f, -1.0f, 1.0f);	// Bottom Left
        gl.glTexCoord2f(1.0f, .33f);
        gl.glVertex3f(1.0f, -1.0f, -1.0f);	// Bottom Right
        gl.glTexCoord2f(1.0f, .66f);
        gl.glVertex3f(1.0f, 1.0f, -1.0f);	// Top Right
        gl.glTexCoord2f(.66f, .66f);
        gl.glVertex3f(1.0f, 1.0f, 1.0f);	// Top Left
        // Top Face
        ...
        gl.glTexCoord2f(.66f, .66f);
        gl.glVertex3f(1.0f, 1.0f, 1.0f);	// Bottom Right
        gl.glTexCoord2f(.66f, 1.0f);
        gl.glVertex3f(1.0f, 1.0f, -1.0f);	// Top Right
        gl.glTexCoord2f(.33f, 1.0f);
        gl.glVertex3f(-1.0f, 1.0f, -1.0f);	// Top Left
        // Bottom Face
        gl.glTexCoord2f(.66f, .33f);
        gl.glVertex3f(1.0f, -1.0f, 1.0f);	// Bottom Left
        gl.glTexCoord2f(.33f, .33f);
        gl.glVertex3f(-1.0f, -1.0f, 1.0f);	// Bottom Right
        gl.glTexCoord2f(.33f, 0.0f);
        gl.glVertex3f(-1.0f, -1.0f, -1.0f);	// Top Right
        gl.glTexCoord2f(.66f, 0.0f);
        gl.glVertex3f(1.0f, -1.0f, -1.0f);	// Top Left
        // Back Face
        gl.glTexCoord2f(.66f, 0.0f);
        gl.glVertex3f(1.0f, -1.0f, -1.0f);	// Bottom Left
